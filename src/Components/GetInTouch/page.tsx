...
const page = () => {
  return (
    <div id="contact-us" className="max-w-full">
      <div className="grid justify-items-center  mr-auto ml-auto">
        <div className="header lg:text-5xl font-bold text-text ssm:text-3xl">
          GET IN TOUCH
        </div>
      </div>
      <div className="m-[50px] rounded bg-slate-50 xl:h-[600px] ssm:h-[820px] sm:h-[850px] md:h-[850px] shadow-2xl  ">
